...
export default function Laboratories({ laboratories, attendanceResponse }: LaboratoriesProps) {
    ...
    const dialogVariants = {
        create: {
            ...
            description: 'Puedes crear un nuevo laboratorio y establecer su horario',
            button: 'Crear',
        },
        edit: {
            title: 'Editar laboratorio',
            description: 'Puedes editar el nombre y el horario de este laboratorio',
            button: 'Actualizar',
        },
    };
    ...
    const deleteAllAttendance = () => {
        destroy(route('attendance.destroy-all'), {
            onSuccess: () => {
                ...
                toast.success('Historial de asistencias eliminado exitosamente');
            },
            onFinish: () => reset(),
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col justify-start gap-4 rounded-xl p-4">
                ...
                <div className="@container/main flex flex-1 flex-col gap-2">
                    <div className="flex flex-col gap-4 md:gap-6">
                            ...
                            {laboratories.map((laboratory) => {
                                return (
                                    <Card key={laboratory.id} className="@container/card">
                                        ...
                                        <CardFooter>
                                            <Button onClick={() => openDialog('edit', laboratory)}>Editar</Button>
                                        </CardFooter>
                                    </Card>
                                );
                            })}
                        ...
                        <div className="@container/main flex flex-1 flex-col gap-4 p-6">
                            <div>
                                <h2 className="text-2xl font-bold tracking-tight">Asistencias de laboratorio</h2>
                                <p className="text-muted-foreground">
                                    Aquí tienes un listado de asistencias que puedes filtrar, buscar, ordenar y exportar.
                                </p>
                            ...
                            <DataTable
                                ...
                                filename="asistencias_laboratorio"
                            />
                        </div>
                    </div>
                </div>
                ...
                {/* Diálogo de confirmación para eliminar todas las asistencias */}
                <AlertDialog open={isDeleteAllDialogOpen} onOpenChange={setIsDeleteAllDialogOpen}>
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            <AlertDialogTitle className="text-destructive">¿Seguro que deseas eliminar todas las asistencias?</AlertDialogTitle>
                            <AlertDialogDescription>
                                Esto eliminará permanentemente el historial de asistencias. Las asistencias activas podrían no verse afectadas.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
