...
export default function Create() {
    ...
    const submit: FormEventHandler = (e) => {
        ...
        post(route('developments.store'), {
            ...
            onError: () => {
                toast.error('Error creating development');
            },
        });
    };
            ...
            <div className="flex h-full flex-col items-center rounded-xl p-4">
                <form onSubmit={submit} className="my-4 w-full max-w-5xl space-y-6" encType="multipart/form-data">
                    <div className="grid gap-2">
                        <Label htmlFor="development_title">Title</Label>
                        <Input
                    ...
                    <div className="grid gap-4 pb-10 text-wrap">
                        <Label htmlFor="development__description">Description</Label>
                        <ReactQuill
                    ...
                    <div className="grid gap-2">
                        <Label htmlFor="development_images">Images</Label>
                        <section className="flex flex-wrap items-center gap-2">
                            {imagesPreview &&
                                imagesPreview.length > 0 &&
                                imagesPreview.map((image) => {
                                    return <img src={image} alt="Development Image" className="aspect-video w-xs border-2 object-contain" />;
                                })}
                        </section>
                        <Input
                        ...
                        />
                        <small className="text-muted-foreground">Allowed formats: webp, jpeg, png, jpg, gif, svg</small>
