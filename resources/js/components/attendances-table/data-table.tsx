...
export function DataTable<TData extends DataTableRow, TValue>({ columns, data }: DataTableProps<TData, TValue>) {
    ...
    const table = useReactTable({
        ...
        globalFilterFn: (row, columnId, filterValue) => {
            const valuesToSearch = [
                ...
                row.original.user_paternal_surname,
                row.original.user_maternal_surname,
            ]
                .join(' ')
                .toLowerCase();
