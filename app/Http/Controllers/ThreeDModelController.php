...
class ThreeDModelController extends Controller
{
    ...
    {
        return Inertia::render('three-d-models/Index', [
    ...
    {
        return Inertia::render('three-d-models/Create', [
            'formats' => Format::all(),
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $files = [
            'image' => [
                'path' => 'three-d-models/images',
                'extension' => null,
                'field' => 'img_url',
            ],
            'model_view' => [
                'path' => 'three-d-models/models',
                'extension' => 'glb',
                'field' => 'model_url',
            ],
            'model_download' => [
    ...
    {
        return Inertia::render('three-d-models/Show', [
    ...
    {
        return Inertia::render('three-d-models/Edit', [
            'model' => $threeDModel->load('format'),
            'formats' => Format::all(),
        ]);
    }
